            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input type="file" required accept=".jpg,.png,.jpeg,.txt" class="form-control blue-border" data-testid="file" />
                    <div id="fileError" data-testid="fileError" class="hidden error">L'extension n'est pas supportée</div>
                  </div>
                </div>
            </div>
            <div class="row">
